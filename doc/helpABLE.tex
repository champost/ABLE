...
{\begin{tcolorbox}[colback=blue!10!gray!10,colframe=white, breakable]}
{\end{tcolorbox}}
...
\newcommand{\incodeEnv}[1]{\tcbox[colback=blue!10!gray!10,colframe=white, on line, size=fbox]{\texttt{#1}}}
...
\begin{itemize}
	...
	\item If you are installing \incode{ABLE} for the \underline{\textbf{first time}} you might have to install the \textbf{GSL} and \textbf{NLopt} libraries. This can take some time as the command below performs a \textbf{static installation} of the libraries. You can skip this step if you already have these libraries installed system-wide or if you are simply updating \ABLE\ to the latest update.
